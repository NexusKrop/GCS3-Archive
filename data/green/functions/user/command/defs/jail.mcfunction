...
execute if entity @a[scores={viceCache=11112,level=..3}] run tellraw @a [{"text": "GCS3","color": "aqua"},{"text": ">> ","color": "white","bold": true},{"text": "玩家","color": "white"},{"selector":"@a[scores={viceCache=11112,level=..3}]"},{"text": "已被管理员送至小黑屋！","color": "white"}]
