...
execute if entity @a[scores={viceCache=12440,level=..3}] run tellraw @a [{"text": "GCS3","color": "aqua"},{"text": ">> ","color": "white","bold": true},{"text": "玩家","color": "white"},{"selector":"@a[scores={viceCache=12440,level=..3}]"},{"text": "因涉嫌违规被管理员封禁","color": "white"}]
